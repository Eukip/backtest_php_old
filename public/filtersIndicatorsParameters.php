...
//@Alexander Lugovskoi
//Очевидно, что тут где то утечка памяти в коде. Обычное дело для php.
//Пока ставлю костыль. Сервер будет отменять все ограничения по памяти и
//и будет использовать всю имеющуюся у него память для работы этих функций.
//В общем эта вся штука нуждается в рефакторинге, очевидно.
//P.S memory error ловлю я и Артем в getOrderPriceByOHLCV
