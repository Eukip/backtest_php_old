...
def test_getOrderPriceByOHLCV():
    ...
    d1 = {'ohlcv': correct_ohlcv, 'priceMinusPerc': 80}
    d1_json = json.dumps(d1)
    print("подготовленный к отправки json: ")
    pprint.pprint(d1_json)
    r1 = requests.post(api_base_url+'getOrderPriceByOHLCV.php', json=d1_json)
